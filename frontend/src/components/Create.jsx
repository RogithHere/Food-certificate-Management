...
function Create() {
  var {mail}=useParams()
    ...
    const handleSubmit = (e) => {
      ...
      // Validation checks
      if (!UserData.Register_No || 
          !UserData.Operator_details.Name || 
          !UserData.Operator_details.Email || 
          !UserData.Operator_details.Phone ||
          !UserData.Operator_details.Address.First_Line ||
          !UserData.Operator_details.Address.Second_Line ||
          !UserData.Operator_details.Address.Pincode ||
          !UserData.Business_details.Kind_of_business ||
          !UserData.Business_details.Address.First_Line ||
          !UserData.Business_details.Address.Second_Line ||
          !UserData.Business_details.Address.Pincode ||
          !UserData.Business_Entity ||
          !UserData.Aadhar ||
          !UserData.PAN ||
          !UserData.Issue ||
          !UserData.Validity ||
          !UserData.Upto ||
          !UserData.Registration_Fee ||
          !UserData.Place ||
          !UserData.Date) {
      ...
      if (!emailPattern.test(UserData.Operator_details.Email)) {
      ...
      if (!phonePattern.test(UserData.Operator_details.Phone)) {
